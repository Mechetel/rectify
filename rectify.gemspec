...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'actionpack',    '~> 7.2.2', '>= 7.2.2'
  spec.add_dependency 'activemodel',   '~> 7.2.2', '>= 7.2.2'
  spec.add_dependency 'activerecord',  '~> 7.2.2', '>= 7.2.2'
  spec.add_dependency 'activesupport', '~> 7.2.2', '>= 7.2.2'
